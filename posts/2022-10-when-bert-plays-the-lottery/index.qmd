...
![BERT plays the lottery: Image from https://thegradient.pub/when-bert-plays-the-lottery-all-tickets-are-winning/](bert-lottery.webp){fig-alt="A cartoon of BERT sesame street along with a bandit machine." style="text-align: center;"}
